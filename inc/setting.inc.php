...
<?php } ?></div>
<div id="bio" >
   <div id="focus"style="font-size:17px;text-shadow:.2px .2px .2px #d9d9d9;font-family:helvetica;color:#000;width:300px;margin-left:150px;margin-top:20px;padding-right:20px;padding-left:20px;">
   <?php
